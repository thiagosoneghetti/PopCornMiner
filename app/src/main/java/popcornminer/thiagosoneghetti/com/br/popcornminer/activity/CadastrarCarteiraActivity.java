...
public class CadastrarCarteiraActivity extends AppCompatActivity {
    ...
    private ImageView btnScanAddCart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastrar_carteira);
        ...
        btnScanAddCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IntentIntegrator intentIntegrator = new IntentIntegrator(CadastrarCarteiraActivity.this);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if ( dataSnapshot.getValue() != null){
                    ...
                    if ( conexaoInternet == true ) {
                        Toast.makeText(context, "Carteira "+ carteiraFB.getDescricao() +" adicionada.", Toast.LENGTH_SHORT).show();
                    } else {
